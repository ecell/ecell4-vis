...
class AddDatasourceDialog(wx.Dialog):
    ...
    def __init__(self, *args, **kwargs):
        """Initializer.
        """
        caption = kwargs.pop('caption', 'Choose Datasource')
        ds_choices = kwargs.pop('choices', [])
        style=kwargs.setdefault('style', wx.CAPTION|wx.CLOSE_BOX)
        kwargs.setdefault('title', 'Datasource Types')
        ...
        # bindings
        self.datasource_choices = ds_choices
...
if __name__=='__main__':
    ...
    class DemoApp(wx.App):
        ...
        def OnButton(self, evt):
            dlg = AddDatasourceDialog(self.frame, choices=['Lancelot', 'Garahad', 'Robin', 'Arthur'])
            ret = dlg.ShowModal()
